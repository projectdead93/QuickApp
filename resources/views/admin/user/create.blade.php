...
<div class="py-2">
        ...
        <label for="username"
            class="block font-medium text-sm text-gray-700{{$errors->has('name') ? ' text-red-400' : ''}}">{{ __('Username') }}</label>
        <input id="username" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 block mt-1 w-full{{$errors->has('username') ? ' border-red-400' : ''}}"
                                                    type="text"
                                                    name="username"
                                                    value="{{ old('username') }}"
                                                    />
